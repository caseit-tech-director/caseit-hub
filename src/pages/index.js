      ...
      <NavigationContextProvider>
        <div className="main-grid center-column">
          ...
          <div className="main-grid__content">
            ...
            <SectionMarker label= "Chair's Welcome" hash="chair_welcome" group="Welcome">
              <Chair />
            </SectionMarker>
            <SectionMarker label= "Dean's Welcome" hash="dean_welcome" group="Welcome">
              <h1 className="display"> Dean's Welcome </h1>
            </SectionMarker>
            <SectionMarker label="About the Competition" hash="about" group="Information">
            <About />
            </SectionMarker>
            <SectionMarker label="Week Overview" hash="week_overview" group="Information">
            <Overview />
            </SectionMarker>
            <SectionMarker label="Competition Structure" hash="comp_structure" group="Information">
            <Structure />
            </SectionMarker>
            <SectionMarker label="Technology" hash="tech" group="Information">
            <Tech />
            </SectionMarker>
            <SectionMarker label="Meet the Teams" hash="teams" group="Stakeholders">
            <h1 className="display"> Meet the Teams </h1>
            </SectionMarker>
            <SectionMarker label="Organizing Committee" hash="oc" group="Stakeholders">
            <OC/>
            </SectionMarker>
            <SectionMarker label="Sponsors" hash="sponsors" group="Stakeholders">
            <Sponsor/>
            </SectionMarker>
          </div>
        </div>
