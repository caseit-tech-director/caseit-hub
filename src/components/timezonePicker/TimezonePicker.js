...
const UNIVERSITY_TIMEZONES = {
  ...
  cu: "Etc/GMT-5", //Concordia University
  cub: "Etc/GMT+1", //Corvinus University of Budapest
  hec: "Etc/GMT-5", //HEC Montréal
  hku: "Etc/GMT+8", //Hong Kong University of Science and Technology
...
// generate a name "session" lookup table 
