  ...
  return (
    <Article heading="Chair's Welcome" group="introduction">
      ...
      <p>
        ...
        CaseIT stakeholders throughout the week-long competition, including more
        than 70 corporate representatives from the Vancouver business community,
        competitors, and faculty from 15 other universities.
        <br></br>
        We are excited to have you compete at our case competition. We hope that
        you are able to challenge yourselves, step outside of your comfort-zone,
        acquire expertise, and achieve personal growth to reach your greatest
        potential. Our team is ecstatic to connect and share with you our
        experiences alongside 60 other competitors.
        <br></br>
        Sincerely,
        <br></br>
        Jordan
